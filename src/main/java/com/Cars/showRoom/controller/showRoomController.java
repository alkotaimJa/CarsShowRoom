...
public class showRoomController {
    ...
    // update a show room
    @PutMapping("showroom/{commercial_registration_number}")
    public ResponseEntity<CarShowroom> updateCarShowroom(
        @PathVariable String commercial_registration_number, 
        @RequestBody UpdateCarShowroomDTO updateDTO) {
        
        CarShowroom updatedShowroom = showRoomService.updateShowroom(commercial_registration_number, updateDTO);
        return ResponseEntity.ok(updatedShowroom);
    }

    // soft delete show room
    @PutMapping("/showroom/{commercial_registration_number}/delete")
    public ResponseEntity<CarShowroom> deleteCarShowroom(@PathVariable String commercial_registration_number) {
        CarShowroom deletedShowroom = showRoomService.deleteShowroom(commercial_registration_number);
        return ResponseEntity.ok(deletedShowroom);
    }
